...
public class Game {
	...
	public HumanPlayer leftPlayer;
	public ComputerPlayer rightPlayer;
	public int size;
	private Board myShip;
	private Board opponentShip;
	private boolean gameMode;
	private TurnSelector turn = new TurnSelector();
	 ...
	 */
	private void setGameMode(boolean gameMode) {
	 ...
	 */
	private void playerShoot(boolean isWater) {
		if (isWater) {
			IO.display("¡TOCADO!");
		} else {
			IO.display("¡AGUA!");
